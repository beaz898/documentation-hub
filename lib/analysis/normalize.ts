/**
 * F-56: extraída de judge.ts a su propio fichero — sin cambiar una línea de
 ...
 * `normalize` desde el mismo sitio de siempre (`export { normalize } from
 * './normalize'`), así que ningún import existente (`from './judge'`, en
 * retrieval.ts y finding-rules.ts) cambia.
 */
 ...
 *
 * F-56: es también lo que decide, dentro de una fila ya localizada, si un
