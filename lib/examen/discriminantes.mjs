 ...
 *
 * El troceado es de ~2.000 caracteres con 200 de solape (`CLAUDE.md`), así que
 * una frase de 40-60 caracteres cerca de una costura puede quedar partida. La
 * comprobación que hicimos el 25/09 —`grep -c` sobre el texto extraído del
 * `.docx`— medía el DOCUMENTO y no dice nada sobre esto.
 *
