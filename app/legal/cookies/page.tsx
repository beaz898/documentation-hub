...
export default async function CookiesPage() {
  ...
  const cookies = [
    {
      ...
      purpose:  t('s2Cookie1Purpose'),
      duration: t('s2Cookie1Duration'),
      type:     t('s2Cookie1Type'),
    },
    {
      name: 'sb-refresh-token',
      purpose:  t('s2Cookie2Purpose'),
      duration: t('s2Cookie2Duration'),
      type:     t('s2Cookie2Type'),
    },
  ];
  ...
  const sections = [
    ...
    },
    {
      number: '3',
      title: t('s3'),
      content: <p>{t('s3Body')}</p>,
    },
    {
      number: '4',
      title: t('s4'),
      content: <p>{t('s4Body')}</p>,
    },
    {
      number: '5',
      title: t('s5'),
      content: <p>{t.rich('s5Body', { email: emailLink })}</p>,
    },
  ];
